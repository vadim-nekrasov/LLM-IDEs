...
|------------------|---------|-------------------|
| Initial/starting number of ideas, seed, brainstorm size | `{max_abstract_variants}` | "посев 10", "изначально 7 вариантов", "начни с 20 идей", "seed 15", "start with 12 options" |
