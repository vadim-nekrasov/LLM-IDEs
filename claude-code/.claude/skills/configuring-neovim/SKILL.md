...
description: Neovim/Vim configuration patterns — lazy.nvim, keymaps, LSP setup, Treesitter. Triggers when editing init.lua, lua/config/, lua/plugins/, or vim scripts.
---
