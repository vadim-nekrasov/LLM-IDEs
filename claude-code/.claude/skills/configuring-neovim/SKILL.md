...
description: Neovim/Vim configuration patterns — lazy.nvim, keymaps, LSP setup, Treesitter, autocommands. Auto-trigger on init.lua / lua/config/ / lua/plugins/ / .vim edits.
paths:
  - "**/init.lua"
  - "**/lua/config/**/*.lua"
  - "**/lua/plugins/**/*.lua"
