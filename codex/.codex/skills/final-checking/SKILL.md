...
- [ ] Design Principles respected (SOLID, GRASP, DRY, KISS, YAGNI)
...
For significant changes, consider invoking the `searching-solutions` skill to find alternatives.
...
Before stopping, output the **Session Summary** as required by AGENTS.md:
