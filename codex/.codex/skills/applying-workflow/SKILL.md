...
- [ ] Design Principles: 
  ...
  - [ ] DRY (if applicable here)
  - [ ] KISS (if applicable here)
  - [ ] YAGNI (if applicable here)
...
If task requires information beyond library docs and web search is enabled, use web search.
If web search is unavailable, ask the user for clarification or sources.
